...
% Taken from https://colorpalettes.net/color-palette-4317/
\definecolor{pala}{HTML}{F6D2AC}
\definecolor{palb}{HTML}{E6AE74}
\definecolor{palc}{HTML}{D6834F}
\definecolor{pald}{HTML}{A35233}
\definecolor{pale}{HTML}{42281C}
...
\begin{tikzpicture}
	...
	\node[circle, draw=black, minimum size=0.4cm, fill=colora] (A0) at (0.8*\xl, \my) {};
	\node[circle, draw=black, minimum size=0.4cm, fill=colora] (A1) at (0.8*\xl, 2*\yl+\my) {};
